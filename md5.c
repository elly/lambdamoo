 ...
 */
static void
md5_Encode(uint8 * output, uint32 * input, unsigned int len)
{
    unsigned int i, j;
 ...
 */
static void
md5_Decode(uint32 * output, uint8 * input, unsigned int len)
{
    unsigned int i, j;
 ...
 */
void
md5_Update(md5ctx_t * context, uint8 * buf, unsigned int len)
{
